...
#define SUB_S_CHANGE_CARD				113									//更新分数
...
struct CMD_S_StatusFree
{
	...
	BYTE								cbRuleOption;						//规则配置
	LONGLONG                            lMinBetValue;                     //最低下注kk jia
};
...
struct CMD_S_StatusScore
{
	...
	BYTE								cbRuleOption;						//规则配置
	LONGLONG                            lMinBetValue;                     //最低下注kk jia
	BYTE								cbControlCard[GAME_PLAYER][4];			//用户扑克	
	BYTE								cbzhuomianCard[28];			//用户扑克	
};
...
#define SUB_C_CHANGE_CARD               6                                // --用户摊牌
