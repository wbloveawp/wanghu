...
/*
* "您好，本房间只有积分为 %s 以下的玩家才能参加游戏，请您到别的房间游戏！"
*/
...
/*
* "您的发送速度太快了，%d秒允许发送一次，请坐下来喝杯茶先休息下吧！，请坐下来喝杯茶休息下吧！"
*/
...
#define MIM_SERVER_0051					(MIM_SERVER+33)						//消息索引

/*
* "\"%s\"俱乐部的老板给您增加" %s "积分，祝您游戏愉快！。"
*/

#define MIM_SERVER_0052					(MIM_SERVER+52)						//消息索引

/*
* "\"%ls\"俱乐部的老板给\"%s\"增加" %s "积分，祝您游戏愉快！。"
*/

#define MIM_SERVER_0053					(MIM_SERVER+53)						//消息索引

/*
* "\"%ls\"俱乐部的成员%s给您赠送" %s "积分，祝您游戏愉快！。"
*/

#define MIM_SERVER_0054					(MIM_SERVER+54)						//消息索引

/*
* "\"%ls\"俱乐部的老板给您增加" %s "贝壳，祝您游戏愉快！。"
*/

#define MIM_SERVER_0055					(MIM_SERVER+55)						//消息索引

/*
* "由于您积分不足，无法继续游戏，请尽快联系老板增加积分！"
*/

#define MIM_SERVER_0056					(MIM_SERVER+56)						//消息索引

/*
* "由于您积分不足，无法继续游戏，牌局结束！请尽快联系老板增加积分！"
*/
...
/*
* "加入游戏至少需要 " %s " 个贝壳，您的贝壳不足不能加入！请联系俱乐部老板添加。"
*/
...
/*
* "加入游戏至少需要 " %s "积分，您的积分不足不能加入！请联系俱乐部老板添加。"
*/
...
#define MIM_LOGIC						3500									//消息索引


//////////////////////////////////////////////////////////////////////////

/*
* "系统维护中，俱乐部暂时停止服务。请稍后再次重试！"
*/

#define MIM_LOGIC_0001					(MIM_LOGIC+1)							//消息索引

/*
* "抱歉, 俱乐部名称中包含敏感词汇, 俱乐部创建失败！"
*/

#define MIM_LOGIC_0002					(MIM_LOGIC+2)							//消息索引

/*
* "抱歉,俱乐部介绍中包含敏感词汇,俱乐部创建失败！"
*/

#define MIM_LOGIC_0003					(MIM_LOGIC+3)							//消息索引

/*
* "抱歉,馆员类型异常,操作失败！"
*/

#define MIM_LOGIC_0004					(MIM_LOGIC+4)							//消息索引

/*
* "抱歉,馆员状态异常,操作失败！"
*/

#define MIM_LOGIC_0005					(MIM_LOGIC+5)							//消息索引

/*
* "您赠送的金额异常,操作失败！"
*/

#define MIM_LOGIC_0006					(MIM_LOGIC+6)							//消息索引

/*
* "您的账号在其他地方登录，您被迫下线！"
*/

#define MIM_LOGIC_0007					(MIM_LOGIC+7)							//消息索引

/*
* "俱乐部升级成功！"
*/

#define MIM_LOGIC_0008					(MIM_LOGIC+8)							//消息索引

/*
* "俱乐部转让成功！"
*/

#define MIM_LOGIC_0009					(MIM_LOGIC+9)							//消息索引

/*
* "抱歉，您已被移出 \"%s\"的俱乐部。"
*/

#define MIM_LOGIC_0010					(MIM_LOGIC+10)							//消息索引

/*
* "%s: %s%s"
*/

#define MIM_LOGIC_0011					(MIM_LOGIC+11)							//消息索引

/*
* "已赠送给玩家%s: %s"
*/

#define MIM_LOGIC_0012					(MIM_LOGIC+12)							//消息索引

/*
* "L"%s: %s" %s "贝壳""
*/

#define MIM_LOGIC_0013					(MIM_LOGIC+13)							//消息索引

/*
* "合并请求发送成功，请耐心等待对方俱乐部老板的处理结果！"
*/

#define MIM_LOGIC_0014					(MIM_LOGIC+14)							//消息索引

/*
* "抱歉，俱乐部\"%s\"老板拒绝了您的合并请求！"
*/

#define MIM_LOGIC_0015					(MIM_LOGIC+15)							//消息索引

/*
* "邀请请求发送成功，请耐心等待对方的处理结果！"
*/

#define MIM_LOGIC_0016					(MIM_LOGIC+16)							//消息索引

/*
* "抱歉，玩家\"%s\"拒绝了您的邀请！"
*/

#define MIM_LOGIC_0017					(MIM_LOGIC+17)							//消息索引

/*
* "代付请求发送成功，请耐心等待对方的处理结果！"
*/

#define MIM_LOGIC_0018					(MIM_LOGIC+18)							//消息索引

/*
* "抱歉，对方拒绝了您的代付请求！"
*/

#define MIM_LOGIC_0019					(MIM_LOGIC+19)							//消息索引
...
#define MIM_LOGIC_0020					(MIM_LOGIC+20)							//消息索引

/*
* "俱乐部创建失败，请联系客服中心了解详细信息！"
*/

#define MIM_LOGIC_0021					(MIM_LOGIC+21)							//消息索引

/*
* "恭喜您，俱乐部创建成功！"
*/

#define MIM_LOGIC_0022					(MIM_LOGIC+22)							//消息索引

/*
* "操作成功！"
*/

#define MIM_LOGIC_0023					(MIM_LOGIC+23)							//消息索引

/*
* "您已被移出俱乐部\"%s\"！"
*/

#define MIM_LOGIC_0024					(MIM_LOGIC+24)							//消息索引

/*
* "俱乐部\"%s\"的老板%s您的加入申请！"
*/

#define MIM_LOGIC_0025					(MIM_LOGIC+25)							//消息索引


//////////////////////////////////////////////////////////////////////////
//群组模块

#define MIM_GROUP						4000									//消息索引


/*
* "您加入的俱乐部\"%s\"已被合并到俱乐部\"%s\"，该茶馆即将被删除，祝您在新俱乐部中游戏愉快！"
*/

#define MIM_GROUP_0001					(MIM_GROUP+1)							//消息索引

/*
* "您已解散俱乐部\"%s\"！"
*/

#define MIM_GROUP_0002					(MIM_GROUP+2)							//消息索引

/*
* "您加入的俱乐部\"%s\"已被老板解散！"
*/

#define MIM_GROUP_0003					(MIM_GROUP+3)							//消息索引

/*
* "您输入的房号有误，无法加入该房间！"
*/

#define MIM_GROUP_0004					(MIM_GROUP+4)							//消息索引

/*
* "您不是该俱乐部的成员不能加入房间！"
*/

#define MIM_GROUP_0005					(MIM_GROUP+5)							//消息索引

/*
* "您已被俱乐部老板冻结游戏权限，请联系老板解除！"
*/

#define MIM_GROUP_0006					(MIM_GROUP+6)							//消息索引

/*
* "俱乐部老板,给您%s%0.0f分"
*/

#define MIM_GROUP_0007					(MIM_GROUP+7)							//消息索引

/*
* "俱乐部成员%s给您赠送%0.0f分"
*/

#define MIM_GROUP_0008					(MIM_GROUP+8)							//消息索引

/*
* "俱乐部老板,给您%s%s贝壳""
*/

#define MIM_GROUP_0009					(MIM_GROUP+9)							//消息索引

/*
* "您的积分已被清零！"
*/

#define MIM_GROUP_0010					(MIM_GROUP+10)							//消息索引

/*
* "系统维护中，俱乐部暂时停止服务。请稍后再次重试！"
*/

#define MIM_GROUP_0011					(MIM_GROUP+11)							//消息索引

/*
* "系统未查询到该俱乐部的信息，进入失败！"
*/

#define MIM_GROUP_0012					(MIM_GROUP+12)							//消息索引

/*
* "抱歉，你不是该俱乐部的成员，进入失败！"
*/

#define MIM_GROUP_0013					(MIM_GROUP+13)							//消息索引

/*
* "系统未查询到您的用户信息，创建失败！"
*/

#define MIM_GROUP_0014					(MIM_GROUP+14)							//消息索引

/*
* "系统未查询到俱乐部信息，创建失败！"
*/

#define MIM_GROUP_0015					(MIM_GROUP+15)							//消息索引

/*
* "您不是俱乐部的老板，没有权限创建桌子！"
*/

#define MIM_GROUP_0016					(MIM_GROUP+16)							//消息索引

/*
* "当前俱乐部尚未开启贝壳权限，无法应用贝壳设置！"
*/

#define MIM_GROUP_0017					(MIM_GROUP+17)							//消息索引

/*
* "系统未查询到您的用户信息，桌子修改失败！"
*/

#define MIM_GROUP_0018					(MIM_GROUP+18)							//消息索引

/*
* "系统未查询到俱乐部信息，桌子修改失败！"
*/

#define MIM_GROUP_0019					(MIM_GROUP+19)							//消息索引

/*
* "您不是俱乐部的老板，没有权限修改桌子！"
*/

#define MIM_GROUP_0020					(MIM_GROUP+20)							//消息索引

/*
* "当前俱乐部尚未开启贝壳权限，无法应用贝壳设置！"
*/

#define MIM_GROUP_0021					(MIM_GROUP+21)							//消息索引

/*
* "系统未查询到您的用户信息，解散失败！"
*/

#define MIM_GROUP_0022					(MIM_GROUP+22)							//消息索引

/*
* "系统未查询到俱乐部信息，解散失败！"
*/

#define MIM_GROUP_0023					(MIM_GROUP+23)							//消息索引

/*
* "您不是俱乐部的老板或管理员，没有权限解散房间！"
*/

#define MIM_GROUP_0024					(MIM_GROUP+24)							//消息索引
...
/*
* "恭喜您,您已玩满%d局游戏,等其他桌完成后系统将进行晋级排名,请您耐心等待！"
*/
...
/*
* "很遗憾，您当前的比赛积分为 %I64d，低于淘汰分 %d，已被淘汰！"
*/
...
#define MIM_BATTLE_0006					(MIM_BATTLE+6)							//消息索引

/*
* "抱歉，房间创建失败[4]，请稍后再次尝试！"
*/

#define MIM_BATTLE_0007					(MIM_BATTLE+7)							//消息索引
...
/*
*  "恭喜！玩家“%s”在游戏“%s”内赢得：%lld。" Congratulations! player “X” got big win: 12.50 in game"Y"
*/

#define MIM_MARQUEE_NOTICY_0001			(MIM_GAME+1)							//消息索引

/*
*  "恭喜！玩家“%s”在游戏“%s”中得奖池金额：%lld。"  "Congratulations! player “X” won the prize pool reward of 12.50 in game"Y""
*/

#define MIM_MARQUEE_NOTICY_0002			(MIM_GAME+2)							//消息索引
