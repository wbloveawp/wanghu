...
//配置管理
#define SUB_CS_C_APPEND_FILTER_WORDS 30									//添加词汇
#define SUB_CS_C_DELETE_FILTER_WORDS 31									//删除词汇
...
//缓存命令
#define SUB_CS_C_UPDATE_USER_CACHE	50									//更新缓存
...
struct CMD_CS_C_SendAuthCode
{
	...
	WCHAR							szMobilePhone[LEN_MOBILE_PHONE];	//手机号码	
};
