...
protected:
	...
	tagDataBaseParameter			m_MatchDBParameter;					//连接信息
...
public:
	//连接信息
	tagDataBaseParameter * GetMatchDBParameter() { return &m_MatchDBParameter; }
	//连接信息
	VOID SetMatchDBParameter(tagDataBaseParameter & GameMatchDBParameter) { m_MatchDBParameter=GameMatchDBParameter; }
