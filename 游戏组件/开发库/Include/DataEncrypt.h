...
public:
	//生成密文
	static bool EncryptData(LPCTSTR pszSourceData, LPTSTR pszEncrypData, WORD wMaxCount);
	//解开密文
	static bool CrevasseData(LPCTSTR pszEncrypData, LPTSTR pszSourceData, WORD wMaxCount);
};
