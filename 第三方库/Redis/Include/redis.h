...
public:
    ...
    Redis(const ConnectionOptions& conn_opts, const ConnectionPoolOptions& pool_opts = {});

    Redis(const std::shared_ptr<Sentinel>& sentinel, const std::string& master_name, Role role, const ConnectionOptions& conn_opts, const ConnectionPoolOptions& pool_opts = {});
    ...
    void init(const ConnectionOptions& connection_opts, const ConnectionPoolOptions& pool_opts = {});

    void init(const std::shared_ptr<Sentinel>& sentinel, const std::string& master_name, Role role, const ConnectionOptions& conn_opts, const ConnectionPoolOptions& pool_opts = {});
