...
public:
    ...
    ConnectionPool(const ConnectionPoolOptions &pool_opts,const ConnectionOptions &conn_opts);

    ConnectionPool(SimpleSentinel sentinel,const ConnectionPoolOptions &pool_opts,const ConnectionOptions & conn_opts);
    ...
    void init(const ConnectionPoolOptions& pool_opts, const ConnectionOptions& conn_opts);
    void init(SimpleSentinel sentinel, const ConnectionPoolOptions& pool_opts, const ConnectionOptions& conn_opts);
