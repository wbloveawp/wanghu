...
BEGIN
	RETURN CASE (@PortNumber%2)
			 WHEN 0 THEN 'E:\数据库\虾米互娱\LHGameBattleDB\'
			 WHEN 1 THEN 'D:\数据库\虾米互娱\LHGameBattleDB\'
			 ELSE 'D:\数据库\虾米互娱\LHGameBattleDB\'
		   END
END
...
SET @TableName='RecordDrawInfo'
SET @DataBaseName='LHGameBattleDB'
