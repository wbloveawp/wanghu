#ifndef REG_KEY_AIDE_HEAD_FILE
#define REG_KEY_AIDE_HEAD_FILE
...
//键项组手
class COMMON_SERVICE_CLASS CRegKeyAide
{
	//键项变量
protected:
	HKEY							m_hRegKey;							//当前键项
...
public:
	...
	//枚举键项
	bool EnumItemString(DWORD dwIndex, LPTSTR pszString, DWORD cbSize);
...
public:
	...
	//写入数据
	bool WriteBinary(LPCTSTR pszName, const VOID * pData, DWORD cbSize);
...
public:
	...
	//读取数据
	DWORD GetBinary(LPCTSTR pszName, VOID * pData, DWORD cbBufferSize);
	//读取字符
