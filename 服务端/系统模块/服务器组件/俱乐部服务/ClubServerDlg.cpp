...
VOID CClubServerDlg::OnCancel()
{
	...
	{
		LPCTSTR pszQuestion = TEXT("俱乐部服务正在运行中，您确实要关闭服务器吗？");
...
VOID CClubServerDlg::SetWindowStatusText(LPCTSTR pszServiceStatus)
{
	...
	_sntprintf_s(szWindowText, CountArray(szWindowText), TEXT("俱乐部服务[%d] -- [ %s ]"), pServiceOption->wServicePort, pszServiceStatus);
