...
//设置配置
void CServiceUnits::SetServiceOption(tagServiceOption &ClubOption)
{
	//拷贝配置
	CopyMemory(&m_ClubOption,&ClubOption,sizeof(m_ClubOption));
}
...
bool CServiceUnits::InitializeService()
{
	...
	//调度回调
	m_AttemperEngineSink.m_pClubOption=&m_ClubOption;
	m_AttemperEngineSink.m_pInitParameter=&m_InitParameter;
	m_AttemperEngineSink.m_pIAttemperEngine = pIAttemperEngine;
	...
	//配置网络
	WORD wMaxConnect=m_ClubOption.wMaxConnect;
	WORD wServicePort=m_ClubOption.wServicePort;
