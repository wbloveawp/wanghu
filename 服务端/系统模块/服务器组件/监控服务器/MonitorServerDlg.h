#ifndef MONITOR_SERVER_DLG_HEAD_FILE
#define MONITOR_SERVER_DLG_HEAD_FILE
...
//主对话框
class CMonitorServerDlg : public CDialog, public IServiceUnitsSink
{
	//组件变量
protected:
