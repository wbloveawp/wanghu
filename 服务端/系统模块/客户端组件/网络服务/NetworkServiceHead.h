...
DECLARE_MODULE_HELPER(TCPSocket, TCPSocket, NETWORK_SERVICE_DLL_NAME,"CreateTCPSocket")
DECLARE_MODULE_HELPER(NetworkManager, NetworkManager, NETWORK_SERVICE_DLL_NAME,"CreateNetworkManager")
