...
#define WM_TRAY_MESSAGE				(WM_USER+100)						//默认消息

//////////////////////////////////////////////////////////////////////////

//事件图标
class CLIENT_CONTROLS_CLASS CSystemTrayIcon
{
	//配置定义
protected:
...
public:
	//配置图标
	bool InitTrayIcon(HWND hWndSend, UINT uTrayID, UINT uMessage=WM_TRAY_MESSAGE);
