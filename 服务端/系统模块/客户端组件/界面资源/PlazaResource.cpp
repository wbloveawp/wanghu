...
VOID __cdecl CPlazaResource::GetPlazaChatImage(tagPlazaChatImage & ResourceInfo)
{
	...
	ResourceInfo.crSplitter=RGB(2,131,191);
...
{
	//颜色定义
	ResourceInfo.crSplitter=RGB(36,80,113);
...
VOID __cdecl CPlazaResource::GetPlazaServiceImage(tagPlazaServiceImage & ResourceInfo)
{
	...
	ResourceInfo.crServiceItemBK=RGB(153,224,248);
...
{
	//颜色信息
	ResourceInfo.crHyperText=RGB(250,250,0);
	ResourceInfo.crHyperBack=RGB(27,105,159);
	ResourceInfo.crUserInfoText=RGB(250,250,250);
...
VOID __cdecl CPlazaResource::GetPlazaCollocateImage(tagPlazaCollocateImage & ResourceInfo)
{
	...
	ResourceInfo.crItemActiveTX=RGB(1,94,152);
