...
//标志权限定义
#define UR_MATCH_USER					0x00000040L				//比赛用户标志

//会员权限
#define UR_GAME_DOUBLE_SCORE			0x00000100L				//游戏双倍积分
#define UR_GAME_KICK_USER				0x00000200L				//踢玩家出本桌
#define UR_GAME_PLAY_CHAT				0x00000400L				//允許同桌遊戲私聊
#define UR_ENTER_WITHOUT_PASSWD			0x00000800L				//允许无需密码入座

//特殊权限
#define UR_CAN_CHEAT					0x08000000L				//特殊权限
...
#define UR_CAN_LIMIT_PLAY_CHAT			0x00000020L				//允许禁止同桌游戏私聊
...
//绑定管理
#define UR_CAN_BIND_GAME				0x01000000L				//允许游戏绑定
#define UR_CAN_BIND_GLOBAL				0x02000000L				//允许全局绑定

//配置管理
#define UR_CAN_MANAGER_ANDROID			0x08000000L				//允许管理机器
#define UR_CAN_ISSUE_MESSAGE			0x10000000L				//允许发布消息
#define UR_CAN_MANAGER_SERVER			0x20000000L				//允许管理房间
#define UR_CAN_MANAGER_OPTION			0x40000000L				//允许管理配置
...
public:
	...
	//踢人权限
	static bool CanKickUser(DWORD dwUserRight) { return (dwUserRight&UR_GAME_KICK_USER)!=0; }
	//允許同桌遊戲私聊
	static bool CanGamePlayChat(DWORD dwUserRight) { return (dwUserRight&UR_GAME_PLAY_CHAT)!=0; }
	//允许无需密码入座
	static bool CanEnterWithoutPasswd(DWORD dwUserRight) { return (dwUserRight&UR_ENTER_WITHOUT_PASSWD)!=0; }
	//特殊权限
	static bool CanCheat(DWORD dwUserRight) { return (dwUserRight&UR_CAN_CHEAT)!=0; }
	//发送喇叭
	static bool CanBugle(DWORD dwUserRight){return (dwUserRight&UR_CANNOT_BUGLE)==0;}
	//比赛标识
...
public:
	...
	//禁止同桌游戏私聊
	static bool CanLimitPlayChat(DWORD dwMasterRight) { return ((dwMasterRight&UR_CAN_LIMIT_PLAY_CHAT)!=0); }
