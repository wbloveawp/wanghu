...
/*
* "您已经申请加入该茶社，不需要重复申请，请耐心等待茶社老板审核！"
*/
...
/*
* "加入游戏至少需要 " %s " 个贝壳，您的贝壳不足不能加入！请联系茶社老板添加。"
*/
...
/*
* "加入游戏至少需要 " %s "积分，您的积分不足不能加入！请联系茶社老板添加。"
*/
