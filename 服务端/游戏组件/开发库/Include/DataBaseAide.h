...
public:
	...
	//获取数据
	VOID GetValue_Binary(LPCTSTR pszItem,BYTE cbBinary[],WORD wArrayLen);
...
public:
	...
	//获取参数
	VOID GetParameter(LPCTSTR pszItem, BYTE cbBinary[],WORD wArrayLen);
...
public:
	...
	//插入参数
	VOID AddParameter(LPCTSTR pszItem, BYTE cbBinary[],UINT uSize,ParameterDirectionEnum ParameterDirection=adParamInput);	
	//插入参数
