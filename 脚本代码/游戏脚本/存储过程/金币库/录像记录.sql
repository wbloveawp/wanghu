...
BEGIN
	...
	BEGIN
		...
		-- 插入记录
		INSERT INTO LHGameRecordDB.dbo.RecordVideoInfo (VideoNumber,KindID,MappedNum,BattleRecordID,VideoCreateTime,UserCount,PlayBackCode,RecordDate)
	...
	BEGIN
		INSERT INTO LHGameRecordDB.dbo.RecordVideoUser(VideoNumber,UserID,MappedNum,RecordDate)
