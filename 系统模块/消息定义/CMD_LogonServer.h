...
//登出命令
#define SUB_GP_LOGOUT_NOTIFY		10									//登出提醒
...
#define DTP_GP_PACKAGE_NAME			12									//应用包名
...
#define MDM_GP_CONFIG_SERVICE		13									//配置服务

//参数操作
#define SUB_GP_QUERY_GAME_CONFIG	100									//查询配置
#define SUB_GP_UPDATE_BASIC_CONFIG	101									//更新配置
#define SUB_GP_UPDATE_WEIGHT_CONFIG	102									//更新配置

//参数信息
#define SUB_GP_GAME_BASIC_CONFIG	200									//基础配置
#define SUB_GP_GAME_WEIGHT_CONFIG	201									//权重配置
#define SUB_GP_GAME_CONFIG_FINISH	202									//配置完成
...
#define MDM_GP_ROBOT_SERVICE		14									//机器服务

//参数操作
#define SUB_GP_QUERY_PARAMETER		100									//查询参数
#define SUB_GP_APPEND_PARAMETER		101									//添加参数
#define SUB_GP_MODIFY_PARAMETER		102									//修改参数
#define SUB_GP_DELETE_PARAMETER		103									//删除参数

//参数信息
#define SUB_GP_ROBOT_OPERATE_RESULT	200									//操作结果
...
#define MDM_GP_STOCK_SERVICE		15									//库存服务

//库存操作
#define SUB_GP_QUERY_STOCK_INFO		100									//查询库存
#define SUB_GP_APPEND_STOCK_INFO	101									//添加库存
#define SUB_GP_MODIFY_STOCK_INFO	102									//修改库存
#define SUB_GP_DELETE_STOCK_INFO	103									//删除库存
#define SUB_GP_ADJUST_STOCK_SCORE	104									//调整库存
#define SUB_GP_ADJUST_JACKPOT_SCORE	105									//调整彩金

//库存信息
#define SUB_GP_STOCK_OPERATE_RESULT	200									//操作结果
...
{
	WORD							wPacketIdx;							//数据索引
	WORD							wSubCommdID;						//子命令码
	WORD							wStockCount;						//库存数目
...
#define SUB_GP_MODIFY_OPTION		1									//修改选项
#define SUB_GP_EXECUTE_COMMAND		2									//执行命令

#define SUB_GP_MANAGE_SUCCESS		100									//管理成功
...
#define SUB_MB_GET_JACKPOT			4									//获取奖池
...
#define SUB_MB_LIST_JACKPOT			110									//奖池信息
...
#define SUB_MB_REAL_AUTH			6									//实名认证
...
#define SUB_MB_QUERY_SUBSIDY		24									//查询低保
...
//请求命令
#define SUB_MB_REQUEST_CHECKIN		70									//请求签到
#define SUB_MB_BIND_INVITE_CODE		71									//绑定邀请码
#define SUB_MB_SUBMIT_INFORM_INFO	72									//提交投诉
#define SUB_MB_BIND_EXTERNAL_ACCOUNT 73									//绑定账号
...
//银行命令
#define SUB_MB_INSURE_QUERY			130									//查询银行
#define SUB_MB_INSURE_ENABLE		131									//银行开通
#define SUB_MB_INSURE_SAVE			132									//银行存储
#define	SUB_MB_INSURE_TAKE			133									//银行提取
#define SUB_MB_INSURE_TRANSFER		134									//银行转账
#define SUB_MB_INSURE_RESET_PASSWORD	135								//银行密码重置
//////////////////////////////////////////////////////////////////////////
...
#define SUB_MB_USER_SUBSIDY			207									//低保数据

//系统命令
#define SUB_MB_SHUTUP_STATUS_UPDATE	210									//状态更新
#define SUB_MB_RESET_USERDATA		211									//重置数据
...
//签到命令
#define SUB_MB_CHECKIN_OPTION		230									//签到配置
#define SUB_MB_CHECKIN_RESULT		231									//签到结果
...
//银行命令
#define SUB_MB_INSURE_QUERY_RESULT		370								//银行查询结果
#define SUB_MB_INSURE_SUCCESS			371								//银行操作成功
#define SUB_MB_INSURE_FAILURE			372								//银行操作失败
...
{
	BYTE							cbEnable;							//开关标识 0-关 1-开
	SCORE							lScore;								//用户余额
	SCORE							lInsureScore;						//银行余额
...
{
	bool							bCheckInEnabled;					//签到开关
	TCHAR							szOptionDigest[LEN_MD5];			//配置摘要
	TCHAR							szCheckInRewards[1024];				//签到奖励
};
...
#define DTP_MB_RANKING_INFO			0x0400								//排位信息
#define DTP_MB_USER_EMAIL			0x0800								//电子邮箱
#define DTP_MB_TRANSFER_PARAM		0x1000								//转账参数
#define DTP_MB_REGISTER_PRESENT		0x2000								//注册赠送
#define DTP_MB_PACKAGE_NAME			0x4000								//应用包名
#define DTP_MB_REAL_AUTH			0x8000								//实名信息
//wwrq#define DTP_MB_LOGON_FACEURL        0x10000	                            //头像地址KK JIA
...
struct DTP_GP_TransferParam
{
	...
	SCORE							lMinTransferAmount;					//转账金额
	SCORE							lMaxTransferAmount;					//转账金额
};
