...
bool CServiceUnits::StartService()
{
	...
	//连接中心
	SendControlPacket(CT_LOAD_BATTLE_OPTION,NULL,0);
...
void _cdecl CServiceUnits::SetServiceOption(tagServiceOption & ServiceOption)
{
	...
	//设置参数
	m_MonitorClient.SetServiceParameter(SERVICE_MODULE_BATTLE, m_ServiceOption.wServiceID, m_ServiceOption.szServiceName);
}
