...
//网络线程
class CTCPSocketServiceThread : public CServiceThread
{
	//内核变量
protected:
	HWND							m_hWnd;								//窗口句柄
...
private:
	...
	//发送函数
	bool PerformSendData(WORD wMainCmdID, WORD wSubCmdID, VOID * pData, WORD wDataSize);
...
protected:
	...
	//读取消息
	bool OnSocketRead(CMD_Command Command, VOID * pData, WORD wDataSize);
