...
//调度引擎 这里应该还有WebSocketService
class CAttemperEngine : public IAttemperEngine, public IAsyncEngineSink,
...
protected:
	...
	IAsyncEngine				    m_AsynchronismEngine;				        //异步引擎
...
public:
	...
	//读取事件
	virtual bool OnEventTCPSocketRead(WORD wServiceID, CMD_Command Command, VOID * pData, WORD wDataSize);
...
public:
	...
	//读取事件
	virtual bool OnEventTCPNetworkRead(DWORD dwSocketID, CMD_Command Command, VOID * pData, WORD wDataSize);
