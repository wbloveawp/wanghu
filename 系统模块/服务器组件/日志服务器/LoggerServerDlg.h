#ifndef Logger_SERVER_DLG_HEAD_FILE
#define Logger_SERVER_DLG_HEAD_FILE
...
//主对话框
class CLoggerServerDlg : public CDialog, public IServiceUnitsSink
{
	//组件变量
protected:
