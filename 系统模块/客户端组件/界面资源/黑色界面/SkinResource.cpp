...
bool __cdecl CSkinResource::GetMenuResource(tagSkinMenuResource & ResourceInfo)
{
	...
	//字体颜色
	ResourceInfo.crNormalText=RGB(38,38,38);
	ResourceInfo.crSelectText=RGB(10,10,10);

	//边框颜色
	ResourceInfo.crMenuBar=RGB(196,196,196);		
	ResourceInfo.crSeparator=RGB(121,121,121);
	ResourceInfo.crNormalBack=RGB(255,255,255);
	ResourceInfo.crSelectBack=RGB(255,245,181);
	ResourceInfo.crSelectBorder=RGB(142,142,142);
...
bool __cdecl CSkinResource::GetDialogResource(tagSkinDialogResource & ResourceInfo)
{
	...
	ResourceInfo.crBackGround=RGB(234,234,234);
...
bool __cdecl CSkinResource::GetHyperLinkResource(tagSkinHyperLinkResource & SkinHyperLinkResource)
{
	...
	SkinHyperLinkResource.crBackColor=RGB(234,234,234);
...
bool __cdecl CSkinResource::GetTabControlResource(tagSkinTabControlResource & ResourceInfo)
{
	...
	ResourceInfo.crControlBack=RGB(234,234,234);
