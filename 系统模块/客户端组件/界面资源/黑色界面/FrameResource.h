...
//颜色定义
#define COLOR_CHAT_BK				RGB(234,234,234)					//聊天背景
#define COLOR_SERVER_TX				RGB(250,250,250)					//列表文字
#define COLOR_SERVER_BK				RGB(71,71,71)						//列表底色

//颜色定义
#define COLOR_SELECT_TX				RGB(0,0,0)							//字体颜色
#define COLOR_SELECT_BK				RGB(212,208,200)					//背景颜色
#define COLOR_NORMAL_TX				RGB(0,0,0)							//字体颜色
#define COLOR_NORMAL_BK				RGB(234,234,234)					//背景颜色
