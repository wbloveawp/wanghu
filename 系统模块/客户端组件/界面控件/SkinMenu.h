...
//菜单属性
class CSkinMenuAttribute : public CSkinResourceManager
{
	friend class CSkinMenuKernel;
...
public:
	...
	//位置信息
protected:
	UINT							m_uItemHeight;						//菜单高度
	UINT							m_uMenuBarWidth;					//图像宽度

	//资源变量
protected:
	CBitImage						m_ImageMenuFlags;					//标志资源
...
private:
	//释放子项
	bool FreeMenuItem(CSkinMenuItem * pSkinMenuItem);
	//获取子项
