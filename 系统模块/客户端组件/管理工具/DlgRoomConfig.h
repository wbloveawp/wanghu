...
//房间管理
class CDlgRoomConfig : public CDlgOptionItem, public IRoomConfig, public ITCPSocketSink, public IUserManagerSink, public ICardDispatcherCallback, public IClientDebugCallback
{
	//用户属性
protected:
...
protected:
	...
	//控件变量
protected:
	CCheckComboBox*					m_pGameList;						//游戏列表
	CCheckComboBox*					m_pServerType;						//房间类型
...
public:
	//初始化
	VOID Initialization(CCheckComboBox* pServerList, CServerListManager* pServerListManager);
