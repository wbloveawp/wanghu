...
//数组说明
typedef CWHArray<CDlgDownLoad *> CDlgDownLoadArray;				//窗口数组
//下载状态
...
protected:
	...
	DWORD							m_dwPlazaStationID;					//广场站点
	DWORD							m_dwUserStationID;					//用户站点
	bool							m_bSilent;							//后台模式
	ULONGLONG						m_uDownloaded;						//已经下载
...
protected:
	...
	CSkinHyperLink					m_HyperDownLoad;					//下载连接
